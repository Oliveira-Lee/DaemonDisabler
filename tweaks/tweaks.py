...
tweaks = {
    ...
    "ThermalMonitor": FeatureFlagTweak("Disable Thermal Monitor", flag_category='com.apple.thermalmonitord', flag_names=['Enabled'], is_list=False, inverted=True, min_version=Version("18.0"))
}